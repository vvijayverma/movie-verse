...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/BNhCEPrYYi)
...
```sh
npx nx serve movie-flix
```

To create a production bundle:

```sh
npx nx build movie-flix
```

To see all available targets to run for a project, run:

```sh
npx nx show project movie-flix
```
